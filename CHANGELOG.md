...
- Standard doctor output now contains profile information

## [1.1.0] - 2026-04-03

### Changed

- Updated Node.js 20 GitHub actions where possible
...
- Replace command threw an error if target didn't exist

## [1.0.1] - 2025-12-26

### Fixed

- Fixed misleading output if open command failed
...
- Updated ice theme
- Beta phase finished, first stable release

## [0.20.1] - 2025-12-07

### Added

- Added success message on open command

## [0.20.0] - 2025-12-07

### Changed

- Open command is now interactive, lets user select item

## [0.19.0] - 2025-12-06

### Added

- Added extensive sanity check to prevent hang on missing passphrase

### Fixed

- Fixed incorrect merging of OS environment with configured environment

## [0.18.2] - 2025-12-06

### Added

- Better progress visualization on backup and archive commands (now showing paths being archived currently)

## [0.18.1] - 2025-12-06

### Changed

- Migrated screen recording (for README.md) to asciinema
...
- Simplified easyborg open command parameters for easier typing
